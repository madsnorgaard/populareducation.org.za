...
// Flat stroke icons, per the design rules: no fills, no rounding.
const ARROW = '<svg aria-hidden="true" class="pswp__icn" viewBox="0 0 32 32" width="32" height="32"><path d="M13 8l8 8-8 8" fill="none" stroke="currentColor" stroke-width="2"/></svg>';
